...
export default function NineGaugePage() {
  return (
    <>
      {/* HERO */}
      <section className="relative h-[60vh] min-h-[450px] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-center px-6 lg:px-10 xl:px-16">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/80">
            Premium UV Stabilized HDPE 9 Gauge Nets manufactured for
            agriculture, greenhouses, nurseries and commercial farming
            applications with superior durability and weather resistance.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 xl:px-16">
          <div className="mb-16 text-center">
            ...
            <h2 className="mt-6 text-4xl font-bold text-[#16331d]">
              Explore 9 Gauge Net Variants
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-lg text-gray-600">
              Choose the ideal 9 Gauge Net solution for your agricultural,
              greenhouse or nursery requirements.
            </p>
          </div>
