...
const images = ["/products/50-tape-net1.jpeg"];

export default function ShadeNet50Page() {
          ...
          <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
            ...
            <div className="overflow-hidden rounded-[34px] border border-[#dce6c5] bg-white shadow-lg">
              ...
              <div className="space-y-6 p-8 leading-8 text-neutral-600">
                <p>
                  Genuine Agro&apos;s <strong>50% 6 Gauge Shade Net</strong> is
                ...
                <p>
                  Designed for long outdoor life, this Shade net protects crops
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="overflow-hidden rounded-[34px] border border-[#dce6c5] bg-white shadow-lg">
            ...
            <div className="divide-y divide-[#edf2e3]">
              {[
                ["Product Name", "50% 6 Gauge Shade Net"],
            ...
            <div className="grid items-center gap-10 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-5 max-w-xl text-lg leading-8 text-white/90">
                  Get factory-direct pricing for 50% 6 Gauge Shade Net. Contact
